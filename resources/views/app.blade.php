...
<!-- Fin Validaciones -->
	...
	<div class="site-header-wrapper">
        <header class="site-header header-navbar" style="background-color: #2F2E2E;">
        ...
        <div class="navbar">
            ...
            <div class="header-right">
                ...
                @if (Auth::guest())
                    ...
                    <div class="user-login-panel user-button" style="color:#FFF;">
                ...
                <div class="site-logo">
                    <h1 class="logo-original"><a href="{{ route ('home') }}"><img src="{{ asset('autostars/images/trovami-logo-beta.png') }}" alt="Logo"></a></h1>
                    <h1 class="isotipo-original"><a href="{{ route ('home') }}"><img src="{{ asset('autostars/images/troovami-vehicles.png') }}" alt="Logo"></a></h1>
                   <!-- <span class="site-tagline">Comprar o vender<br>ahora es más fácil!</span>-->
                </div>
