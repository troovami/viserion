...
<html>
  ...
  <body class="nomobile">
    ...
    <section id="header">
        <div class="container">
            ...
            <header>
                <!-- HEADLINE -->
                <h1 data-animated="GoIn"><b>Troovami</b> el sitio web para la venta de vehículos estará en linea pronto...</h1>
            </header>
        ...
        <div id="slider" class="rev_slider">
            <ul>
              <li data-transition="slideleft" data-slotamount="1" data-thumb="{{ asset('autostars/images/slide3_.jpg') }}">
                <img src="{{ asset('autostars/images/slide3_.jpg') }}">
              </li>
  ...
  function get15dayFromNow() {
    ...
    return new Date(new Date().valueOf() + 5 * 24 * 60 * 60 * 1000);
  }
  ...
  $clock.countdown(get15dayFromNow(), function(event) {
    ...
    var $this = $(this);
    if (event.elapsed) {
    	window.location.assign("http://www.lapatilla.com")
    }   
