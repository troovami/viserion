...
@section('content')
    ...
    <!-- Start Body Content -->
                    ...
                    <div class="col-md-8 col-sm-8">
				    	...
				    	{!! Form::open(['route' => 'publicarMotocicleta', 'id' => 'demo-form', 'data-parsley-validate', 'class' => 'listing-add-form','enctype'=>'multipart/form-data', 'onKeypress' => 'if(event.keyCode == 13) event.returnValue = false']) !!}
